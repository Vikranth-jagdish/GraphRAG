"""
Main Pydantic AI agent for Medical Knowledge Graph RAG - Clinical Decision Support System.
"""
...
async def get_entity_relationships(
    ...
    This tool explores the knowledge graph to find how a specific medical entity
    (condition, medication, test, procedure) relates to other entities. Best for
    understanding how medical conditions, medications, or treatments relate to each other.
    
    Args:
        entity_name: Name of the entity to explore (e.g., "Type 2 diabetes", "metformin", "HbA1c")
...
async def get_entity_timeline(
    ...
    This tool retrieves chronological information about a medical entity,
    showing how information has evolved over time. Best for understanding
    how treatment protocols or medical knowledge about an entity has developed or changed.
    
    Args:
        entity_name: Name of the entity (e.g., "Type 2 diabetes", "hypertension", "breast cancer")
