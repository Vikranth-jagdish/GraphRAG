"""
FastAPI endpoints for the Medical Knowledge Graph RAG - Clinical Decision Support System.
"""
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting up Medical Knowledge Graph RAG API...")
    ...
    try:
        ...
        logger.info("Medical Knowledge Graph RAG API startup complete")
    ...
    # Shutdown
    logger.info("Shutting down Medical Knowledge Graph RAG API...")
...
# Create FastAPI app
app = FastAPI(
    title="Medical Knowledge Graph RAG - Clinical Decision Support System",
    description="AI-powered clinical decision support system combining vector search and knowledge graph for evidence-based differential diagnosis and treatment planning using ICMR guidelines",
    version="0.1.0",
    lifespan=lifespan
)
