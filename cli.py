#!/usr/bin/env python3
"""
Command Line Interface for Medical Knowledge Graph RAG - Clinical Decision Support System.

This CLI connects to the API and provides an interactive interface for clinical queries,
differential diagnosis, and treatment planning based on ICMR medical guidelines.
"""
...
class AgenticRAGCLI:
    """CLI for interacting with the Medical Knowledge Graph RAG API."""
    ...
    def print_banner(self):
        ...
        print("🏥 Medical Knowledge Graph RAG - Clinical Decision Support CLI")
        print("=" * 60)
...
{Colors.BOLD}Examples:{Colors.END}
  - "A 45-year-old male presents with polyuria, polydipsia, and weight loss. What are the differential diagnoses?"
  - "What is the first-line treatment for Type 2 diabetes according to ICMR guidelines?"
  - "How should hypertension be managed in a patient with Type 2 diabetes?"
"""
        print(help_text)
    ...
    async def run(self):
        ...
        print(f"{Colors.GREEN}Ready to chat! Ask me clinical questions about diagnosis, treatment, and medical guidelines.{Colors.END}\n")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="CLI for Medical Knowledge Graph RAG - Clinical Decision Support System",
